...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col md:flex-row bg-surface">
      ...
      <div class="hidden md:flex flex-col justify-between w-1/2 bg-secondary p-12 text-white relative overflow-hidden">
        <div class="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1557821552-17105176677c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80')] bg-cover bg-center"></div>
